...
# apply_homography(img_path, Hinv, num_partitions = 16, suff = '_p2p')
...
apply_homography(img_path, H_vl, num_partitions = 4, suff = vp_suff)
...
# apply_homography(img_path, np.dot(hinv(H_af), H_vl), num_partitions=4, suff = '_out')
...
# print H
# print hinv(H)
# apply_homography(img_path, hinv(H), num_partitions = 4, suff = gh_suff)
